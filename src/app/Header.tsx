...
function Header(): JSX.Element {
  ...
  const item = plugUserDate ? (
    ...
    <div className={classes.accountInfo}>
      ...
      <Link className={classes.link_signIn} to='/sign-in'>Sign In</Link>
      <Link className={classes.link_register} to='/sign-up'>Register</Link>
    </div>
  );
  ...
  return (
    <header className={classes.header}>
      ...
      <ul className={classes.listLink}>
        <li className={classes.link}><NavLink className={classes.navlink} to='/doctor'>Список докторов</NavLink></li>
        ...
        <li className={classes.link}><NavLink className={classes.navlink} to='/forum'>Форум</NavLink></li>
      </ul>
      {item}
    </header>
  );
